/**
 * 로그인·회원가입 모달/페이지 공통 색 (레퍼런스: #192731, #2a3843, #4f6172, #E42980).
...
export const authModalGoogleChevronClass =
  "h-8 w-8 shrink-0 text-[#E42980] sm:h-[2.125rem] sm:w-[2.125rem]";

export const authModalGlowTop =
  "pointer-events-none absolute -left-16 -top-20 h-52 w-52 rounded-full bg-[#E42980]/14 blur-3xl";
...
export const authModalGoogleButtonShadow =
  "shadow-[0_18px_38px_-20px_rgba(228,41,128,0.42),0_14px_32px_-18px_rgba(255,255,255,0.52)]";
...
export const loginPageAmbientBg =
  "bg-[radial-gradient(circle_at_18%_12%,rgba(228,41,128,0.2),transparent_44%),radial-gradient(circle_at_82%_88%,rgba(79,97,114,0.28),transparent_46%),linear-gradient(180deg,#192731_0%,#161f28_52%,#0f1419_100%)]";
