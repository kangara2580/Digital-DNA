...
/** 모바일 탐색·상세 — 가로 전폭 구매 CTA */
export const explorePurchaseButtonMobileClass =
  "relative flex w-full min-w-0 items-center justify-center rounded-full border-2 border-white/40 bg-black/35 px-6 py-3 min-h-[48px] text-[15px] font-extrabold tracking-[0.12em] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-sm transition active:scale-[0.96] disabled:cursor-not-allowed disabled:opacity-40 [html[data-theme='light']_&]:border-zinc-900/55 [html[data-theme='light']_&]:bg-white/80 [html[data-theme='light']_&]:text-zinc-900";
