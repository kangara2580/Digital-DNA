...
export function SellerPitchBanner() {
  return (
    ...
    >
      <div className="relative mx-auto max-w-[1800px] px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="relative mx-auto w-full max-w-[1600px] overflow-visible rounded-2xl bg-transparent px-5 py-10 sm:px-8 sm:py-12 lg:px-12 lg:py-14">
          ...
          <div className="relative mt-14 sm:mt-16">
            <p className="text-center text-[clamp(1.6rem,3.4vw,2.4rem)] font-semibold tracking-tight text-zinc-100">
              이렇게 이용해 보세요
            </p>
            <div className="mx-auto mt-7 w-full max-w-[1120px] sm:mt-8">
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:mt-10 sm:grid-cols-3 sm:gap-5">
                <div className="rounded-xl border border-white/28 bg-white/[0.03] px-4 py-5 text-center shadow-[0_10px_24px_-16px_rgba(0,0,0,0.35)] sm:min-h-[170px]">
                  ...
                  <p className="mt-3 text-[14px] leading-relaxed text-zinc-300 sm:text-[16px]">플랫폼 URL을 불러오시거나 직접 영상을 올려 주세요.</p>
                </div>
                <div className="rounded-xl border border-white/28 bg-white/[0.03] px-4 py-5 text-center shadow-[0_10px_24px_-16px_rgba(0,0,0,0.35)] sm:min-h-[170px]">
                  <p className="text-base font-bold text-white sm:text-xl">2. 거래</p>
                  <p className="mt-3 text-[14px] leading-relaxed text-zinc-300 sm:text-[16px]">필요한 영상을 구매하시거나 내 영상을 판매하실 수 있어요.</p>
                </div>
                <div className="rounded-xl border border-white/28 bg-white/[0.03] px-4 py-5 text-center shadow-[0_10px_24px_-16px_rgba(0,0,0,0.35)] sm:min-h-[170px]">
          ...
          <div className="relative mt-14 flex flex-col items-center gap-7 text-center lg:flex-row lg:items-center lg:justify-center lg:gap-14 lg:text-left sm:mt-16">
            <div className="min-w-0 lg:w-auto lg:flex-none">
              <div className="flex items-center justify-center gap-4 lg:justify-start">
                <div className="min-w-0">
                  <h2
                    id="seller-pitch-heading"
                    className="text-[22px] font-medium leading-snug tracking-tight text-zinc-100 sm:text-[26px] md:text-[28px]"
                  >
                    <span className="block text-white">당신의 비디오에 합당한 가치를 더하세요</span>
                  </h2>
                  <div className="mx-auto mt-2 h-px w-52 bg-white/30 sm:w-64 lg:mx-0 lg:w-[26rem]" />

                  <p className="mx-auto mt-3 max-w-lg text-[14px] leading-relaxed text-zinc-300 sm:mt-3.5 sm:text-[15px] lg:mx-0">
