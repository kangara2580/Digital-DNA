      ...
      : mode === "pill"
        ...
        : mode === "compact"
          ? tallPinkTrailCompact
            ? `h-11 min-h-[2.75rem] rounded-full border border-white/40 bg-black/20 pl-3.5 ${showTrailingIcon ? "pr-10" : "pr-3.5"} text-[13px] text-zinc-100 shadow-[0_0_0_1px_rgba(255,255,255,0.05)] backdrop-blur-md hover:border-white/52 hover:bg-black/28 focus:bg-black/28 ${pinkBorder} [html[data-theme='dark']_&]:text-zinc-50 [html[data-theme='light']_&]:border-zinc-300 [html[data-theme='light']_&]:bg-white/[0.6] [html[data-theme='light']_&]:text-zinc-900 [html[data-theme='light']_&]:shadow-[0_0_0_1px_rgba(0,0,0,0.05)] [html[data-theme='light']_&]:hover:border-zinc-400 [html[data-theme='light']_&]:hover:bg-white/[0.72] [html[data-theme='light']_&]:focus:bg-white/[0.72]`
  ...
  if (exploreWatchExpand) {
    ...
    return (
      <form
        ...
        className={`group relative ml-auto flex h-11 max-w-11 shrink-0 flex-row items-center justify-end self-center overflow-visible rounded-none border border-transparent bg-transparent py-0 shadow-none backdrop-blur-0 ${expandedWidthClasses} hover:overflow-hidden hover:rounded-full hover:border-white/28 hover:bg-white/20 hover:pr-1 hover:backdrop-blur-md focus-within:overflow-hidden focus-within:rounded-full focus-within:border-white/28 focus-within:bg-white/20 focus-within:pr-1 focus-within:backdrop-blur-md motion-reduce:overflow-hidden motion-reduce:rounded-full motion-reduce:border-white/25 motion-reduce:bg-white/[0.18] motion-reduce:pr-1 ${exploreWatchExpandTransition} [html[data-theme='dark']_&]:hover:border-white/30 [html[data-theme='dark']_&]:hover:bg-white/25 [html[data-theme='dark']_&]:focus-within:border-white/30 [html[data-theme='dark']_&]:focus-within:bg-white/25 [html[data-theme='light']_&]:hover:border-zinc-300 [html[data-theme='light']_&]:hover:bg-white/98 [html[data-theme='light']_&]:focus-within:border-zinc-300 [html[data-theme='light']_&]:focus-within:bg-white`}
        onPointerEnter={
