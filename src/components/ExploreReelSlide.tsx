...
export function ExploreReelSlide({
  ...
  return (
    ...
    >
        <div className="flex w-full max-w-[min(56rem,calc(100vw-var(--reels-rail-w,0px)-1.5rem))] flex-row items-center justify-center gap-2 px-2 md:gap-3 md:px-4 lg:gap-4">
