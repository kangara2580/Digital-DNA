...
export function SellerFeedSellCta({ sellerId }: { sellerId: string }) {
  ...
  return (
    <div className="mb-3 flex flex-wrap items-center gap-1.5 sm:mb-4">
      ...
      <Link
        href="/sell"
        className="min-w-0 inline-flex items-center gap-1.5 rounded-lg px-2 py-1.5 text-[16px] font-semibold leading-none outline-none transition-[background-color] hover:bg-white/[0.08] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--reels-point)]/35 [html[data-theme='light']_&]:hover:bg-zinc-200/50 [html[data-theme='light']_&]:focus-visible:ring-reels-crimson/25"
      >
        <span
          className="shrink-0 translate-y-[-3px] text-[30px] font-semibold leading-none text-[color:var(--reels-point)]"
          aria-hidden
        >
          +
        </span>
        <span className="leading-none text-white [html[data-theme='light']_&]:text-zinc-900">
