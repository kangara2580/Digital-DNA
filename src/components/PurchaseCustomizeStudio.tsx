...
function previewToneFromPrompt(prompt: string): string {
  ...
  if (p.includes("neon") || p.includes("네온")) {
    return "linear-gradient(140deg, rgba(0,242,234,0.2), rgba(228,41,128,0.18))";
  }
...
const quickBuyButtonClass =
  "inline-flex shrink-0 items-center justify-center rounded-full border border-reels-crimson/45 bg-reels-crimson/15 px-4 py-2.5 text-[12px] font-extrabold text-reels-crimson shadow-[0_0_20px_-8px_rgba(228,41,128,0.42)] transition hover:bg-reels-crimson/25 md:self-auto";
