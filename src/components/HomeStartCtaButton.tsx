...
/**
 * 홈·하이라이트 공통 시작 CTA — 옅은 검정 필 + 2px 반투명 화이트 테두리,
...
export function HomeStartCtaButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`group inline-flex shrink-0 cursor-pointer items-center justify-center gap-2.5 rounded-full border-2 border-white/38 bg-black/25 ${sizeCls} font-semibold tracking-[-0.02em] text-white transition-[box-shadow,background-color,border-color] duration-300 ease-out hover:border-[color:var(--reels-point)] hover:bg-black/38 hover:shadow-[0_8px_24px_-12px_rgba(0,0,0,0.5)] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-reels-crimson/45 focus-visible:ring-offset-0 [html[data-theme='light']_&]:border-black [html[data-theme='light']_&]:bg-white/80 [html[data-theme='light']_&]:text-zinc-950 [html[data-theme='light']_&]:hover:border-[color:var(--reels-point)] [html[data-theme='light']_&]:hover:bg-white [html[data-theme='light']_&]:hover:shadow-[0_6px_20px_-10px_rgba(0,0,0,0.12)] disabled:cursor-not-allowed disabled:opacity-45 disabled:hover:border-white/38 disabled:hover:bg-black/25 disabled:hover:shadow-none disabled:[html[data-theme='light']_&]:hover:border-black disabled:[html[data-theme='light']_&]:hover:bg-white/80`}
    >
